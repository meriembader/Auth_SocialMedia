export class AppConstants {
    private static API_BASE_URL = "http://localhost:8080/"; // http://localhost:8080/oauth2/authorization/google
    private static OAUTH2_URL = AppConstants.API_BASE_URL + "oauth2/authorization/";
    private static REDIRECT_URL = "?redirect_uri=http://localhost:8080/login"; //4200 nrmlment 
